...
(
	...
	[id_user_credential] nvarchar(128) NOT NULL
)
GO
...
ALTER TABLE [USER] ADD CONSTRAINT [FK_USER_USER_CREDENTIAL]
	FOREIGN KEY ([id_user_credential]) REFERENCES [USER_CREDENTIAL] ([Id]) ON DELETE No Action ON UPDATE No Action
GO
